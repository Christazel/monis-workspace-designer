...
export const DESKS: Product[] = [
  {
    ...
    rating: 4.9,
    reviewCount: 312,
    image: '/assets/desks/standing-oak.svg',
  ...
  },
  {
    ...
    rating: 4.8,
    reviewCount: 187,
    image: '/assets/desks/walnut-executive.svg',
  ...
  },
  {
    ...
    rating: 4.7,
    reviewCount: 421,
    image: '/assets/desks/white-minimal.svg',
  ...
  },
  {
    ...
    rating: 4.6,
    reviewCount: 95,
    image: '/assets/desks/glass-corner.svg',
...
export const CHAIRS: Product[] = [
  ...
  },
  {
    ...
    rating: 4.7,
    reviewCount: 534,
    image: '/assets/chairs/markus-mesh.svg',
  ...
  },
  {
    ...
    rating: 4.6,
    reviewCount: 178,
    image: '/assets/chairs/nordic-task.svg',
  ...
  },
  {
    ...
    rating: 4.4,
    reviewCount: 143,
    image: '/assets/chairs/gaming-racer.svg',
...
export const TECH: Product[] = [
  {
    ...
    rating: 4.9,
    reviewCount: 214,
    image: '/assets/tech/ultrawide.svg',
  ...
  },
  {
    ...
    rating: 4.8,
    reviewCount: 502,
    image: '/assets/tech/keyboard-mouse.svg',
  ...
  },
  {
    ...
    rating: 4.7,
    reviewCount: 189,
    image: '/assets/tech/webcam-4k.svg',
  ...
  {
    id: 'tech-speakers',
    name: 'Edifier R1280T Studio Monitors',
    subtitle: 'Bookshelf Desktop Speakers',
    category: 'tech',
    subCategory: 'audio',
    price: 55000,
    rating: 4.7,
    reviewCount: 148,
    image: '/assets/tech/speakers.svg',
    description: 'Powered bookshelf studio monitors with warm, balanced sound. Perfect for music, calls, and ambient lo-fi while coding in Bali. RCA + aux input.',
    features: ['42W total RMS power', 'Natural wood finish panel', 'Adjustable bass & treble', 'RCA + 3.5mm aux input', 'Active/passive pair'],
    badge: 'topbali',
    inStock: true,
  },
];
...
export const ACCESSORIES: Product[] = [
  {
    ...
    rating: 4.8,
    reviewCount: 276,
    image: '/assets/accessories/screenbar.svg',
  ...
  },
  {
    ...
    rating: 4.9,
    reviewCount: 445,
    image: '/assets/accessories/monstera.svg',
  ...
  },
  {
    ...
    rating: 4.8,
    reviewCount: 167,
    image: '/assets/accessories/espresso.svg',
  ...
  },
  {
    ...
    rating: 4.7,
    reviewCount: 93,
    image: '/assets/accessories/surfboard.svg',
  ...
  },
  {
    ...
    rating: 4.5,
    reviewCount: 88,
    image: '/assets/accessories/bean-bag.svg',
...
export function formatMonthlyRate(dailyPriceIDR: number, currency: 'IDR' | 'USD'): string {
  const monthlyTotal = dailyPriceIDR * 30 * (1 - DURATION_DISCOUNTS.monthly.discount);
  return currency === 'IDR' ? `${formatIDR(monthlyTotal)}/bln` : `${formatUSD(monthlyTotal)}/mo`;
}
